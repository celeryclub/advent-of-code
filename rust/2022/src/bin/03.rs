...
fn main() {
    let input = include_str!("../../../../_input/2022/03.txt").trim_end();
...
#[cfg(test)]
mod tests {
    const INPUT: &str = include_str!("../../../../_input/2022/03.txt");

    #[test]
    fn part1() {
        assert_eq!(super::part1(INPUT.trim_end()), 8072);
    }

    #[test]
    fn part2() {
        assert_eq!(super::part2(INPUT.trim_end()), 2567);
    }
}
